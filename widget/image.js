    ...
    render(){
        return(
            <div className="input_div" style={this.props.style}>
                ...
                <form id={this.state.upload} style={{display:'flex'}} enctype="multipart/form-data" method="post">
                    <input type="file"
                           name="file"
                           id={this.state.id}
                           style={{display:!this.props.type||this.props.type==="img"?"none":'flex'}}
                           onChange={()=>{
                    ...
                    <div style={this.props.close_style?this.props.close_style:{display:"none"}}
