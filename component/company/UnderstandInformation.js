...
class UnderstandInformation extends Widget.Base{//掌牧资讯
    constructor(props) {
        super(props);
        // 初始状态
        this.state = {
    ...
    getInformations(){
        this.getDataByPost(1,information_homeUrl+"/informationController/v1.0/getSystemInformations"
            ,{page:this.state.page,information_state:this.state.information_state,class_id:5},{type:2})
    }
    ...
    render(){
        return(
            <div style={{background:'#ffffff',display:'flex',flexDirection:'column'}}>
                <Widget.Toolbar title={"个人心得列表"} history={this.props.history}></Widget.Toolbar>
...
module.exports=UnderstandInformation;