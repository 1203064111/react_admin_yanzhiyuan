...
class InformationClassEditor extends Widget.Base{
    ...
    getInformationClassDetail(){
        this.getDataByPost(1,information_homeUrl+"/informationController/v1.0/getSystemInformationClass",{class_id:this.state.class_id});
    }
    ...
    insertInformationClass(){
        ...
        if(this.state.class_id==="-1"){
            this.getDataByPost(2,information_homeUrl+"/informationController/v1.0/insertSystemInformationClass",params);
        }else{
            params["class_id"]=this.state.class_id;
            this.getDataByPost(3,information_homeUrl+"/informationController/v1.0/updateSystemInformationClass",params);
        }
    }
