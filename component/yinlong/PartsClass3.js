...
class PartsClass3 extends Widget.Base{
    constructor(props) {
        super(props);
        // 初始状态
        this.state = {
    ...
    deletePratsClass(){
        this.getDataByPost(2,maintail_homeurl+"/pratsClassController/v1.0/deletePratsClass",{class_id:this.state.class_id})
    }
    exportPratsClassesV3(){
        this.getDataByPost(5,maintail_homeurl+"/pratsClassController/v1.0/exportPratsClassesV3",{parent_id:this.state.parent_id})
    }
