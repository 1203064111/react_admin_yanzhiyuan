...
class Information extends Widget.Base{//掌牧资讯
    ...
    getInformationClasss(){
        this.getDataByPost(1,information_homeUrl+"/informationController/v1.0/getInformationClasss"
            ,{page:this.state.page,information_state:this.state.information_state},{type:2})
    }

    deleteInformationClass(){
        this.getDataByPost(2,information_homeUrl+"/informationController/v1.0/deleteInformationClass",{class_id:this.state.class_id})
    }
            ...
            <div style={{background:'#ffffff',display:'flex',flexDirection:'column'}}>
                ...
                <Widget.View>
                    <Widget.Button
                        ...
                        value="添加"
                        onClick={()=>{
                            this.props.history.push("/i_information_class_editor/-1");
                        }}/>
                </Widget.View>
                <Widget.List
                    data={[
                    ...
                    operationClick={(rowID,index)=>{
                        switch (index){
                            case 0:
                                this.props.history.push("/i_information_class_editor/"+this.state.informationClassBeans[rowID].class_id);
                                break;
                            case 1:
                                this.openTip("确认删除?",()=>{
                                    this.setState({
