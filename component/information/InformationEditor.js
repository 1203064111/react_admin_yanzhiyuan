...
class InformationDetail extends Widget.Base{
    ...
    getInformationClasss(){
        this.getDataByPost(4,information_homeUrl+"/informationController/v1.0/getInformationClasss"
            ,{})
    }

    getInformationDetail(){
        this.getDataByPost(1,information_homeUrl+"/informationController/v1.0/getInformationDetail",{information_id:this.state.information_id});
    }
    ...
    insertInformation(){
        ...
        if(this.state.information_id==="-1"){
            this.getDataByPost(2,information_homeUrl+"/informationController/v1.0/insertInformation",params);
        }else{
            params["information_id"]=this.state.information_id;
            this.getDataByPost(3,information_homeUrl+"/informationController/v1.0/updateInformation",params);
        }
    }
    renderDetail(){
        return(
            ...
            <div>
                ...
                <Widget.Detail
                    ...
                    baseData={[
                        ...
                        {name:'来源',flex:'1',key:'information_resource'},
