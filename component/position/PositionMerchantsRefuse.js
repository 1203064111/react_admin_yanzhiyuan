...
var type="material3";
class PositionMerchantsRefuse extends Widget.Base{
    constructor(props) {
        super(props);
        // 初始状态
        this.state = {
            ...
            material_state:this.getNull(this.getSessionStorage(type+"material_state"),'2'),
...
module.exports=PositionMerchantsRefuse;
