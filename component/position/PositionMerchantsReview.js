...
var type="material2";
class PositionMerchantsReview extends Widget.Base{
    constructor(props) {
        super(props);
        // 初始状态
        this.state = {
            ...
            material_state:this.getNull(this.getSessionStorage(type+"material_state"),'0'),
...
module.exports=PositionMerchantsReview;
