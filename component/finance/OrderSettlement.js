    ...
    getOrderMerchants(){
        ...
        this.getDataByPost(1,shop_homeurl+"/orderController/v1.0/getOrderMerchants",
            {page:this.state.page,
                ...
                is_settlement:this.state.is_settlement,
            })

        this.getDataByPost(4,shop_homeurl+"/orderController/v1.0/getSettlementPrices",
            {page:this.state.page,
                merchants_id:this.state.merchants_id
                ,order_state:"close"
                ,member_id:this.state.member_id
            ...
            <div>
                ...
                <Widget.View>
                    <Widget.Select
                        ...
                        onChange={(index)=>{
                            this.setState({
                                is_settlement:this.state.stateBeans[index].value
                            })
                        }}/>
                    <Widget.Date
                        title="开始时间"
                ...
                <Widget.View>
                    ...
                    <Widget.Button
                        ...
                        onClick={()=>{
                            ...
                            this.getDataByPost(3,shop_homeurl+"/orderController/v1.0/settlementOrders",{order_id:this.state.order_arr.toString()});
                        }}/>
                </Widget.View>
                <Widget.View background="#ffffff">
                    <Widget.Text
                        style={{display:"flex",marginLeft:20}}
                        title="总支付金额"
                        value={this.state.settlementBean.order_actual_price}/>
                    <Widget.Text
                        style={{display:"flex",marginLeft:20}}
                        title="总退款金额"
                        value={this.state.settlementBean.refund_price}/>
                    <Widget.Text
                        style={{display:"flex",marginLeft:20}}
                        title="总结算金额"
                        value={this.state.settlementBean.settlement_wholesale_price}/>
                </Widget.View>
                <Widget.List
                    data={[
                        ...
                        {name:"结算金额",flex:1,key:'settlement_wholesale_price'},
                        {name:"结算状态",flex:1,key:"is_settlement_show"},
                        {name:"完成时间",flex:1,key:'close_time'},
                        {name:"结算时间",flex:1,key:'settlement_time'},
