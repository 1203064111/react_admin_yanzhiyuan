...
class MerchantsAccount extends Widget.Base{
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
            ...
            <div style={{background:'#ffffff',display:'flex',flexDirection:'column'}}>
                ...
                <Widget.View>
                    <Widget.Button
                        ...
                        value="添加"
                        onClick={()=>{
                            this.props.history.push("/merchants_account_editor/"+encodeURIComponent(JSON.stringify({system_type:this.state.system_type})));
                        }}/>
                </Widget.View>
                <Widget.List
...
module.exports=MerchantsAccount;