...
class MarketingGoodsClass extends Widget.Base{
    constructor(props) {
        super(props);
        // 初始状态
        this.state = {
    ...
    componentDidMount() {
        this.getGoodsClassMarketings();
        this.getGoodsClassOutMarketings();
    }
    getGoodsClassMarketings(){
        this.getDataByPost(1,shop_homeurl+"/goodsController/v1.0/getGoodsClassMarketings"
            ,{page:this.state.page,marketing_type:this.state.marketing_type},{type:2})
    }
    getGoodsClassOutMarketings(){
        this.getDataByPost(6,shop_homeurl+"/goodsController/v1.0/getGoodsClassOutMarketings"
            ,{page:this.state.goods_class_page,
                marketing_type:this.state.marketing_type
                ,class_name:this.state.class_name})
    }
    insertGoodsClassMarketing(){
        this.getDataByPost(7,shop_homeurl+"/goodsController/v1.0/insertGoodsClassMarketing",
            {marketing_type:this.state.marketing_type,
                class_id:this.state.goods_class_arr.toString()})
    }

    deleteGoodsClassMarketing(){
        this.getDataByPost(2,shop_homeurl+"/goodsController/v1.0/deleteGoodsClassMarketing",{marketing_id:this.state.marketing_id})
    }
        ...
        return(
            <div style={{background:'#ffffff',display:'flex',flexDirection:'column'}}>
                <Widget.Tip visible={this.state.visible} msg="确定删除?"
                            ...
                            onPress={()=>{
                                this.deleteGoodsClassMarketing();
                            }}></Widget.Tip>
                ...
                <Widget.View>
                    ...
                    <Widget.Button
                        ...
                        value="添加"
                        onClick={()=>{
                            this.openHtml("#goodsClass","请选择商品分类");
                        }}/>
                ...
                <Widget.List
                    ...
                    onChange={(rowID,key,value)=>{
                        if(key==="sort"){
                            this.getDataByPost(3,shop_homeurl+"/goodsController/v1.0/moveGoodsClassMarketing"
                                ,{marketing_id:this.state.marketingGoodsClassBeans[rowID].marketing_id
                                    ,marketing_type:this.state.marketing_type
                ...
                <Widget.View>
                    ...
                    <Widget.Button
                        ...
                        onClick={()=> {
                            ...
                            this.insertGoodsClassMarketing();
                        }}/>
                </Widget.View>
                <Widget.List
                    data={[
    ...
    getGoodsClasss(value){
        this.getDataByPost(4,shop_homeurl+"/goodsController/v1.0/getGoodsClasss",{page:1,parent_id:"-1",class_name:value})
    }
}

module.exports=MarketingGoodsClass;