...
var type="merchants";
class Merchants extends Widget.Base{
    constructor(props) {
        super(props);
        // 初始状态
    ...
    render(){
        return(
            <div style={{background:'#ffffff',display:'flex',flexDirection:'column'}}>
                ...
                <Widget.Toolbar title={"商家列表"} history={this.props.history}></Widget.Toolbar>
                ...
                <Widget.View>
                    <Widget.Button
                        ...
                        value="添加"
                        onClick={()=>{
                            this.props.history.push("/goods_merchants_editor/-1");
                        }}/>
                    <Widget.Button
                        style={{display:"flex",marginLeft:20}}
                        value="搜索"
