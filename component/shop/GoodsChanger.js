...
var type="goods";
class GoodsChanger extends Widget.Base{
    constructor(props) {
        super(props);
        // 初始状态
        this.state = {
            ...
            <div>
                ...
                <Widget.View>
                    ...
                    <Widget.Button
                        ...
                        value="添加"
                        onClick={()=>{
                            this.props.history.push("/goods_editor/-1/-1/2");
                        }}/>
                </Widget.View>
                <Widget.List
                    data={[{name:"商品ID",flex:1,key:'goods_id'},
                        {name:"商品名称",flex:1,key:'goods_name'},
                        {name:"商品颜值币",flex:1,key:'goods_monnaie'},
