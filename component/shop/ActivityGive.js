    ...
    render(){
        return(
            <div style={{background:'#ffffff',display:'flex',flexDirection:'column'}}>
                ...
                <Widget.Toolbar title={"满赠优惠"} history={this.props.history}></Widget.Toolbar>
                <Widget.View>
                    <Widget.Button
                        ...
                        value="添加"
                        onClick={()=>{
                            this.props.history.push("/goods_activity_give_editor/-1");
                        }}/>
                </Widget.View>
                <Widget.List
                    data={[
                    ...
                    operationClick={(rowID,index)=>{
                        switch (index){
                            case 0:
                                this.props.history.push("/goods_activity_give_editor/"+this.state.activityBeans[rowID].activity_id);
                                break;
                            case 1:
                                this.setState({
                                    visible:true,
