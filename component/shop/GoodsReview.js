...
var type="goods_review";
class GoodsReview extends Widget.Base{
    constructor(props) {
        super(props);
        // 初始状态
    ...
    render(){
        return(
            <div>
                <Widget.Toolbar title={"待审商品"} history={this.props.history}></Widget.Toolbar>
                <Widget.View>
                    <Widget.Editor
