...
class SceneGiveEditor extends Widget.Base{
    ...
    getSenceGoodss2(){
        this.getDataByPost(7,koubei_homeurl+"/sceneController/v1.0/getSenceGoodss"
            ,{scene_id:this.state.scene_id,scene_goods_type:'2'})
    }
    getSceneDetail(){
                ...
                <Widget.Detail
                    ...
                    <Widget.List
                        data={[
                            ...
                            {name:"创建时间",flex:1,key:'create_time'},
                            {name:"操作",flex:2,key:"-1"}]}
                        dataSource={this.state.sceneGoodsBeans2}
                        operationData={[{title:"删除"}]}
                        operationClick={(rowID,index)=>{
                            switch (index){
                                case 0:
                                    this.openTip("确认删除?",()=>{
                                        this.getDataByPost(8,koubei_homeurl+"/sceneController/v1.0/deleteSenceGoods",
                                            {scene_id:this.state.scene_id,scene_goods_id:this.state.sceneGoodsBeans2[rowID].scene_goods_id});
                                    });
                                    break;
                            }
                        }}>
